package net.fhirfactory.pegacorn.petasos.wup.sta.common;
...
public abstract class GenericSTAWUPTemplate {
    ...
    private WorkUnitProcessorTopologyNode buildSTAClientNode() {
        ...
        WorkUnitProcessorTopologyNode wup = getTopologyFactory().createWorkUnitProcessor(specifySTAClientName(), specifySTAClientVersion(),getWorkshop(), PetasosComponentTypeEnum.WUP);
    ...
    public PetasosComponentTypeToken getApiClientNodeFunction() {
